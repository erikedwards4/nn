...
int main(int argc, char *argv[])
{
    ...
    if (i1.T==1)
    {
        ...
        if (openn::wx_s(Y,X,i1.iscolmajor(),int(i1.R),int(i1.C),W,N,dim))
    ...
    else if (i1.T==2)
    {
        ...
        if (openn::wx_d(Y,X,i1.iscolmajor(),int(i1.R),int(i1.C),W,N,dim))
        { cerr << progstr+": " << __LINE__ << errstr << "problem during function call" << endl; return 1; }
        if (wo1)
        {
            try { ofs1.write(reinterpret_cast<char*>(Y),o1.nbytes()); }
    ...
    else if (i1.T==101)
    {
        ...
        if (openn::wx_c(Y,X,i1.iscolmajor(),int(i1.R),int(i1.C),W,N,dim))
        { cerr << progstr+": " << __LINE__ << errstr << "problem during function call" << endl; return 1; }
        if (wo1)
        {
            try { ofs1.write(reinterpret_cast<char*>(Y),o1.nbytes()); }
    ...
    else if (i1.T==102)
    {
        ...
        if (openn::wx_z(Y,X,i1.iscolmajor(),int(i1.R),int(i1.C),W,N,dim))
        { cerr << progstr+": " << __LINE__ << errstr << "problem during function call" << endl; return 1; }
        if (wo1)
        {
            try { ofs1.write(reinterpret_cast<char*>(Y),o1.nbytes()); }
