...
Static_Act: step smoothstep logistic logsigmoid hardsigmoid tanh tanhshrink hardtanh atan asinh gudermann sqnl isru isrlu erf gelu gelu_new relu relu6 prelu elu celu selu softclip softplus softsign plu silu swish hardswish mish sin
