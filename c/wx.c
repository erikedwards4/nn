...
int wx_s (float *Y, const float *X, const char iscolmajor, const int R, const int C, const float *W, const int N, const int dim);
int wx_d (double *Y, const double *X, const char iscolmajor, const int R, const int C, const double *W, const int N, const int dim);
int wx_c (float *Y, const float *X, const char iscolmajor, const int R, const int C, const float *W, const int N, const int dim);
int wx_z (double *Y, const double *X, const char iscolmajor, const int R, const int C, const double *W, const int N, const int dim);
...
int wx_s (float *Y, const float *X, const char iscolmajor, const int R, const int C, const float *W, const int N, const int dim)
{
    ...
    //Checks
    if (R<1) { fprintf(stderr,"error in wx_s: R (nrows X) must be positive\n"); return 1; }
    if (C<1) { fprintf(stderr,"error in wx_s: C (ncols X) must be positive\n"); return 1; }
    ...
    {
        fprintf(stderr,"error in wx_s: dim must be 0 or 1.\n"); return 1;
    }
...
int wx_d (double *Y, const double *X, const char iscolmajor, const int R, const int C, const double *W, const int N, const int dim)
{
    ...
    //Checks
    if (R<1) { fprintf(stderr,"error in wx_d: R (nrows X) must be positive\n"); return 1; }
    if (C<1) { fprintf(stderr,"error in wx_d: C (ncols X) must be positive\n"); return 1; }
    ...
    {
        fprintf(stderr,"error in wx_d: dim must be 0 or 1.\n"); return 1;
    }
...
int wx_c (float *Y, const float *X, const char iscolmajor, const int R, const int C, const float *W, const int N, const int dim)
{
    ...
    //Checks
    if (R<1) { fprintf(stderr,"error in wx_c: R (nrows X) must be positive\n"); return 1; }
    if (C<1) { fprintf(stderr,"error in wx_c: C (ncols X) must be positive\n"); return 1; }

    if (dim==0)
    {
        cblas_ccopy(N*C,&z[0],0,Y,1);
        if (iscolmajor)
        {
    ...
    {
        fprintf(stderr,"error in wx_c: dim must be 0 or 1.\n"); return 1;
    }
...
int wx_z (double *Y, const double *X, const char iscolmajor, const int R, const int C, const double *W, const int N, const int dim)
{
    ...
    //Checks
    if (R<1) { fprintf(stderr,"error in wx_z: R (nrows X) must be positive\n"); return 1; }
    if (C<1) { fprintf(stderr,"error in wx_z: C (ncols X) must be positive\n"); return 1; }

    if (dim==0)
    {
        cblas_zcopy(N*C,&z[0],0,Y,1);
        if (iscolmajor)
        {
    ...
    {
        fprintf(stderr,"error in wx_z: dim must be 0 or 1.\n"); return 1;
    }
