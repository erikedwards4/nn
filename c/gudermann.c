...
{
    for (size_t n=N; n>0u; --n, ++X, ++Y) { *Y = 2.0f * atanf(tanhf(0.5f**X)); }
...
{
    for (size_t n=N; n>0u; --n, ++X, ++Y) { *Y = 2.0 * atan(tanh(0.5**X)); }
...
{
    for (size_t n=N; n>0u; --n, ++X) { *X = 2.0f * atanf(tanhf(0.5f**X)); }
...
{
    for (size_t n=N; n>0u; --n, ++X) { *X = 2.0 * atan(tanh(0.5**X)); }
