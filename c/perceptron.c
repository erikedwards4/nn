...
int perceptron_s (float *Y, const float *X, const int N, const float thresh);
int perceptron_d (double *Y, const double *X, const int N, const double thresh);

int perceptron_inplace_s (float *X, const int N, const float thresh);
int perceptron_inplace_d (double *X, const int N, const double thresh);
