...
int fir_s (float *Y, const float *X, const float *B, const int N, const int T, const int L, const int dim, const char iscolmajor);
int fir_d (double *Y, const double *X, const double *B, const int N, const int T, const int L, const int dim, const char iscolmajor);
int fir_c (float *Y, const float *X, const float *B, const int N, const int T, const int L, const int dim, const char iscolmajor);
int fir_z (double *Y, const double *X, const double *B, const int N, const int T, const int L, const int dim, const char iscolmajor);
