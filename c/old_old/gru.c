...
int gru_s (float *Y, const float *X, const float *U, const float *Ur, const float *Uz, const size_t N, const size_t T, const char iscolmajor, const size_t dim)
{
    ...
    if (dim==0)
    {
        if (iscolmajor)
        {
            ...
            {
                tN = t*N; tN3 = 3*tN;
                cblas_scopy((int)N,&X[tN3+N],1,(int)R,1); cblas_scopy((int)N,&X[tN3+N2],1,Z,1);
        ...
        else
        {
            ...
            for (size_t t=1; t<T; ++t)
            {
                cblas_scopy((int)N,&X[NT+t],(int)T,(int)R,1); cblas_scopy((int)N,&X[NT2+t],(int)T,Z,1);
...
int gru_d (double *Y, const double *X, const double *U, const double *Ur, const double *Uz, const size_t N, const size_t T, const char iscolmajor, const size_t dim)
{
    ...
    if (dim==0)
    {
        if (iscolmajor)
        {
            ...
            {
                tN = t*N; tN3 = 3*tN;
                cblas_dcopy((int)N,&X[tN3+N],1,(int)R,1); cblas_dcopy((int)N,&X[tN3+N2],1,Z,1);
        ...
        else
        {
            ...
            for (size_t t=1; t<T; ++t)
            {
                cblas_dcopy((int)N,&X[NT+t],(int)T,(int)R,1); cblas_dcopy((int)N,&X[NT2+t],(int)T,Z,1);
    ...
    if (dim==0)
    {
        if (iscolmajor)
        {
            ...
            for (size_t t=1; t<T; ++t)
            {
                tN = t*N; tN3 = 3*tN;
                cblas_scopy((int)N,&X[tN3+N],1,(int)R,1); cblas_scopy((int)N,&X[tN3+N2],1,Z,1);
                cblas_sgemv(CblasColMajor,CblasNoTrans,(int)N,(int)N,o,Ur,(int)N,&X[tN3-N3],1,o,(int)R,1);
    ...
    else if (dim==1)
    {
        ...
        else
        {
            ...
            for (size_t t=1; t<T; ++t)
            {
                tN = t*N; tN3 = 3*tN;
                cblas_scopy((int)N,&X[tN3+N],1,(int)R,1); cblas_scopy((int)N,&X[tN3+N2],1,Z,1);
                cblas_sgemv(CblasRowMajor,CblasTrans,(int)N,(int)N,o,Ur,(int)N,&X[tN3-N3],1,o,(int)R,1);
    ...
    if (dim==0)
    {
        if (iscolmajor)
        {
            ...
            for (size_t t=1; t<T; ++t)
            {
                tN = t*N; tN3 = 3*tN;
                cblas_dcopy((int)N,&X[tN3+N],1,(int)R,1); cblas_dcopy((int)N,&X[tN3+N2],1,Z,1);
                cblas_dgemv(CblasColMajor,CblasNoTrans,(int)N,(int)N,o,Ur,(int)N,&X[tN3-N3],1,o,(int)R,1);
    ...
    else if (dim==1)
    {
        ...
        else
        {
            ...
            for (size_t t=1; t<T; ++t)
            {
                tN = t*N; tN3 = 3*tN;
                cblas_dcopy((int)N,&X[tN3+N],1,(int)R,1); cblas_dcopy((int)N,&X[tN3+N2],1,Z,1);
                cblas_dgemv(CblasRowMajor,CblasTrans,(int)N,(int)N,o,Ur,(int)N,&X[tN3-N3],1,o,(int)R,1);
