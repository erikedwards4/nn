...
int lstm4_s (float *Y, const float *Xc, const float *Xi, const float *Xf, const float *Xo, const float *Uc, const float *Ui, const float *Uf, const float *Uo, const size_t N, const size_t T, const char iscolmajor, const size_t dim)
{
    ...
    else if (dim==0)
    {
        if (iscolmajor)
        {
            ...
            {
                tN = t*N;
                cblas_scopy((int)N,&Xc[tN],1,(int)C,1); cblas_scopy((int)N,&Xi[tN],1,I,1);
        ...
        else
        {
            ...
            for (size_t t=1; t<T; ++t)
            {
                cblas_scopy((int)N,&Xc[t],(int)T,(int)C,1); cblas_scopy((int)N,&Xi[t],(int)T,I,1);
...
int lstm4_d (double *Y, const double *Xc, const double *Xi, const double *Xf, const double *Xo, const double *Uc, const double *Ui, const double *Uf, const double *Uo, const size_t N, const size_t T, const char iscolmajor, const size_t dim)
{
    ...
    else if (dim==0)
    {
        if (iscolmajor)
        {
            ...
            {
                tN = t*N;
                cblas_dcopy((int)N,&Xc[tN],1,(int)C,1); cblas_dcopy((int)N,&Xi[tN],1,I,1);
        ...
        else
        {
            ...
            for (size_t t=1; t<T; ++t)
            {
                cblas_dcopy((int)N,&Xc[t],(int)T,(int)C,1); cblas_dcopy((int)N,&Xi[t],(int)T,I,1);
    ...
    else if (dim==0)
    {
        if (iscolmajor)
        {
            ...
            for (size_t t=1; t<T; ++t)
            {
                ...
                cblas_scopy((int)N,&Xc[tN],1,(int)C,1); cblas_scopy((int)N,&Xi[tN],1,I,1);
                cblas_scopy((int)N,&Xf[tN],1,F,1); cblas_scopy((int)N,&Xo[tN],1,O,1);
                cblas_sgemv(CblasColMajor,CblasNoTrans,(int)N,(int)N,o,Uc,(int)N,&Xc[tN-N],1,o,(int)C,1);
        ...
        else
        {
            ...
            for (size_t t=1; t<T; ++t)
            {
                cblas_scopy((int)N,&Xc[t],(int)T,(int)C,1); cblas_scopy((int)N,&Xi[t],(int)T,I,1);
                cblas_scopy((int)N,&Xf[t],(int)T,F,1); cblas_scopy((int)N,&Xo[t],(int)T,O,1);
                cblas_sgemv(CblasRowMajor,CblasNoTrans,(int)N,(int)N,o,Uc,(int)N,&Xc[t-1],(int)T,o,(int)C,1);
    ...
    else if (dim==1)
    {
        if (iscolmajor)
        {
            ...
            for (size_t t=1; t<T; ++t)
            {
                cblas_scopy((int)N,&Xc[t],(int)T,(int)C,1); cblas_scopy((int)N,&Xi[t],(int)T,I,1);
                cblas_scopy((int)N,&Xf[t],(int)T,F,1); cblas_scopy((int)N,&Xo[t],(int)T,O,1);
                cblas_sgemv(CblasColMajor,CblasTrans,(int)N,(int)N,o,Uc,(int)N,&Xc[t-1],(int)T,o,(int)C,1);
        ...
        else
        {
            ...
            for (size_t t=1; t<T; ++t)
            {
                ...
                cblas_scopy((int)N,&Xc[tN],1,(int)C,1); cblas_scopy((int)N,&Xi[tN],1,I,1);
                cblas_scopy((int)N,&Xf[tN],1,F,1); cblas_scopy((int)N,&Xo[tN],1,O,1);
                cblas_sgemv(CblasRowMajor,CblasTrans,(int)N,(int)N,o,Uc,(int)N,&Xc[tN-N],1,o,(int)C,1);
    ...
    else if (dim==0)
    {
        if (iscolmajor)
        {
            ...
            for (size_t t=1; t<T; ++t)
            {
                ...
                cblas_dcopy((int)N,&Xc[tN],1,(int)C,1); cblas_dcopy((int)N,&Xi[tN],1,I,1);
                cblas_dcopy((int)N,&Xf[tN],1,F,1); cblas_dcopy((int)N,&Xo[tN],1,O,1);
                cblas_dgemv(CblasColMajor,CblasNoTrans,(int)N,(int)N,o,Uc,(int)N,&Xc[tN-N],1,o,(int)C,1);
        ...
        else
        {
            ...
            for (size_t t=1; t<T; ++t)
            {
                cblas_dcopy((int)N,&Xc[t],(int)T,(int)C,1); cblas_dcopy((int)N,&Xi[t],(int)T,I,1);
                cblas_dcopy((int)N,&Xf[t],(int)T,F,1); cblas_dcopy((int)N,&Xo[t],(int)T,O,1);
                cblas_dgemv(CblasRowMajor,CblasNoTrans,(int)N,(int)N,o,Uc,(int)N,&Xc[t-1],(int)T,o,(int)C,1);
    ...
    else if (dim==1)
    {
        if (iscolmajor)
        {
            ...
            for (size_t t=1; t<T; ++t)
            {
                cblas_dcopy((int)N,&Xc[t],(int)T,(int)C,1); cblas_dcopy((int)N,&Xi[t],(int)T,I,1);
                cblas_dcopy((int)N,&Xf[t],(int)T,F,1); cblas_dcopy((int)N,&Xo[t],(int)T,O,1);
                cblas_dgemv(CblasColMajor,CblasTrans,(int)N,(int)N,o,Uc,(int)N,&Xc[t-1],(int)T,o,(int)C,1);
        ...
        else
        {
            ...
            for (size_t t=1; t<T; ++t)
            {
                ...
                cblas_dcopy((int)N,&Xc[tN],1,(int)C,1); cblas_dcopy((int)N,&Xi[tN],1,I,1);
                cblas_dcopy((int)N,&Xf[tN],1,F,1); cblas_dcopy((int)N,&Xo[tN],1,O,1);
                cblas_dgemv(CblasRowMajor,CblasTrans,(int)N,(int)N,o,Uc,(int)N,&Xc[tN-N],1,o,(int)C,1);
