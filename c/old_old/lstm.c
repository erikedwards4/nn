...
int lstm_s (float *Y, const float *X, const float *Uc, const float *Ui, const float *Uf, const float *Uo, const size_t N, const size_t T, const char iscolmajor, const size_t dim)
{
    ...
    if (dim==0)
    {
        if (iscolmajor)
        {
            ...
            {
                tN = t*N; tN4 = 4*tN;
                cblas_scopy((int)N,&X[tN4],1,(int)C,1); cblas_scopy((int)N,&X[tN4+N],1,I,1);
                cblas_scopy((int)N,&X[tN4+N2],1,F,1); cblas_scopy((int)N,&X[tN4+N3],1,O,1);
                cblas_sgemv(CblasColMajor,CblasNoTrans,(int)N,(int)N,o,Uc,(int)N,&Y[tN-N],1,o,(int)C,1);
        ...
        else
        {
            ...
            for (size_t t=1; t<T; ++t)
            {
                cblas_scopy((int)N,&X[t],(int)T,(int)C,1); cblas_scopy((int)N,&X[NT+t],(int)T,I,1);
                cblas_scopy((int)N,&X[NT2+t],(int)T,F,1); cblas_scopy((int)N,&X[NT3+t],(int)T,O,1);
                cblas_sgemv(CblasRowMajor,CblasNoTrans,(int)N,(int)N,o,Uc,(int)N,&Y[t-1],(int)T,o,(int)C,1);
    ...
    else if (dim==1)
    {
        if (iscolmajor)
        {
            ...
            for (size_t t=1; t<T; ++t)
            {
                cblas_scopy((int)N,&X[t],(int)T,(int)C,1); cblas_scopy((int)N,&X[NT+t],(int)T,I,1);
                cblas_scopy((int)N,&X[NT2+t],(int)T,F,1); cblas_scopy((int)N,&X[NT3+t],(int)T,O,1);
                cblas_sgemv(CblasColMajor,CblasTrans,(int)N,(int)N,o,Uc,(int)N,&Y[t-1],(int)T,o,(int)C,1);
        ...
        else
        {
            ...
            for (size_t t=1; t<T; ++t)
            {
                ...
                cblas_scopy((int)N,&X[tN4],1,(int)C,1); cblas_scopy((int)N,&X[tN4+N],1,I,1);
                cblas_scopy((int)N,&X[tN4+N2],1,F,1); cblas_scopy((int)N,&X[tN4+N3],1,O,1);
                cblas_sgemv(CblasRowMajor,CblasTrans,(int)N,(int)N,o,Uc,(int)N,&Y[tN-N],1,o,(int)C,1);
...
int lstm_d (double *Y, const double *X, const double *Uc, const double *Ui, const double *Uf, const double *Uo, const size_t N, const size_t T, const char iscolmajor, const size_t dim)
{
    ...
    if (dim==0)
    {
        if (iscolmajor)
        {
            ...
            {
                tN = t*N; tN4 = 4*tN;
                cblas_dcopy((int)N,&X[tN4],1,(int)C,1); cblas_dcopy((int)N,&X[tN4+N],1,I,1);
                cblas_dcopy((int)N,&X[tN4+N2],1,F,1); cblas_dcopy((int)N,&X[tN4+N3],1,O,1);
                cblas_dgemv(CblasColMajor,CblasNoTrans,(int)N,(int)N,o,Uc,(int)N,&Y[tN-N],1,o,(int)C,1);
        ...
        else
        {
            ...
            for (size_t t=1; t<T; ++t)
            {
                cblas_dcopy((int)N,&X[t],(int)T,(int)C,1); cblas_dcopy((int)N,&X[NT+t],(int)T,I,1);
                cblas_dcopy((int)N,&X[NT2+t],(int)T,F,1); cblas_dcopy((int)N,&X[NT3+t],(int)T,O,1);
                cblas_dgemv(CblasRowMajor,CblasNoTrans,(int)N,(int)N,o,Uc,(int)N,&Y[t-1],(int)T,o,(int)C,1);
    ...
    else if (dim==1)
    {
        if (iscolmajor)
        {
            ...
            for (size_t t=1; t<T; ++t)
            {
                cblas_dcopy((int)N,&X[t],(int)T,(int)C,1); cblas_dcopy((int)N,&X[NT+t],(int)T,I,1);
                cblas_dcopy((int)N,&X[NT2+t],(int)T,F,1); cblas_dcopy((int)N,&X[NT3+t],(int)T,O,1);
                cblas_dgemv(CblasColMajor,CblasTrans,(int)N,(int)N,o,Uc,(int)N,&Y[t-1],(int)T,o,(int)C,1);
        ...
        else
        {
            ...
            for (size_t t=1; t<T; ++t)
            {
                ...
                cblas_dcopy((int)N,&X[tN4],1,(int)C,1); cblas_dcopy((int)N,&X[tN4+N],1,I,1);
                cblas_dcopy((int)N,&X[tN4+N2],1,F,1); cblas_dcopy((int)N,&X[tN4+N3],1,O,1);
                cblas_dgemv(CblasRowMajor,CblasTrans,(int)N,(int)N,o,Uc,(int)N,&Y[tN-N],1,o,(int)C,1);
    ...
    if (dim==0)
    {
        if (iscolmajor)
        {
            ...
            for (size_t t=1; t<T; ++t)
            {
                ...
                cblas_scopy((int)N,&X[tN4],1,(int)C,1); cblas_scopy((int)N,&X[tN4+N],1,I,1);
                cblas_scopy((int)N,&X[tN4+N2],1,F,1); cblas_scopy((int)N,&X[tN4+N3],1,O,1);
                cblas_sgemv(CblasColMajor,CblasNoTrans,(int)N,(int)N,o,Uc,(int)N,&X[tN4-N4],1,o,(int)C,1);
        ...
        else
        {
            ...
            for (size_t t=1; t<T; ++t)
            {
                cblas_scopy((int)N,&X[t],(int)T,(int)C,1); cblas_scopy((int)N,&X[NT+t],(int)T,I,1);
                cblas_scopy((int)N,&X[NT2+t],(int)T,F,1); cblas_scopy((int)N,&X[NT3+t],(int)T,O,1);
                cblas_sgemv(CblasRowMajor,CblasNoTrans,(int)N,(int)N,o,Uc,(int)N,&X[t-1],(int)T,o,(int)C,1);
    ...
    else if (dim==1)
    {
        if (iscolmajor)
        {
            ...
            for (size_t t=1; t<T; ++t)
            {
                cblas_scopy((int)N,&X[t],(int)T,(int)C,1); cblas_scopy((int)N,&X[NT+t],(int)T,I,1);
                cblas_scopy((int)N,&X[NT2+t],(int)T,F,1); cblas_scopy((int)N,&X[NT3+t],(int)T,O,1);
                cblas_sgemv(CblasColMajor,CblasTrans,(int)N,(int)N,o,Uc,(int)N,&X[t-1],(int)T,o,(int)C,1);
        ...
        else
        {
            ...
            for (size_t t=1; t<T; ++t)
            {
                ...
                cblas_scopy((int)N,&X[tN4],1,(int)C,1); cblas_scopy((int)N,&X[tN4+N],1,I,1);
                cblas_scopy((int)N,&X[tN4+N2],1,F,1); cblas_scopy((int)N,&X[tN4+N3],1,O,1);
                cblas_sgemv(CblasRowMajor,CblasTrans,(int)N,(int)N,o,Uc,(int)N,&X[tN4-N4],1,o,(int)C,1);
    ...
    if (dim==0)
    {
        if (iscolmajor)
        {
            ...
            for (size_t t=1; t<T; ++t)
            {
                ...
                cblas_dcopy((int)N,&X[tN4],1,(int)C,1); cblas_dcopy((int)N,&X[tN4+N],1,I,1);
                cblas_dcopy((int)N,&X[tN4+N2],1,F,1); cblas_dcopy((int)N,&X[tN4+N3],1,O,1);
                cblas_dgemv(CblasColMajor,CblasNoTrans,(int)N,(int)N,o,Uc,(int)N,&X[tN4-N4],1,o,(int)C,1);
        ...
        else
        {
            ...
            for (size_t t=1; t<T; ++t)
            {
                cblas_dcopy((int)N,&X[t],(int)T,(int)C,1); cblas_dcopy((int)N,&X[NT+t],(int)T,I,1);
                cblas_dcopy((int)N,&X[NT2+t],(int)T,F,1); cblas_dcopy((int)N,&X[NT3+t],(int)T,O,1);
                cblas_dgemv(CblasRowMajor,CblasNoTrans,(int)N,(int)N,o,Uc,(int)N,&X[t-1],(int)T,o,(int)C,1);
    ...
    else if (dim==1)
    {
        if (iscolmajor)
        {
            ...
            for (size_t t=1; t<T; ++t)
            {
                cblas_dcopy((int)N,&X[t],(int)T,(int)C,1); cblas_dcopy((int)N,&X[NT+t],(int)T,I,1);
                cblas_dcopy((int)N,&X[NT2+t],(int)T,F,1); cblas_dcopy((int)N,&X[NT3+t],(int)T,O,1);
                cblas_dgemv(CblasColMajor,CblasTrans,(int)N,(int)N,o,Uc,(int)N,&X[t-1],(int)T,o,(int)C,1);
        ...
        else
        {
            ...
            for (size_t t=1; t<T; ++t)
            {
                ...
                cblas_dcopy((int)N,&X[tN4],1,(int)C,1); cblas_dcopy((int)N,&X[tN4+N],1,I,1);
                cblas_dcopy((int)N,&X[tN4+N2],1,F,1); cblas_dcopy((int)N,&X[tN4+N3],1,O,1);
                cblas_dgemv(CblasRowMajor,CblasTrans,(int)N,(int)N,o,Uc,(int)N,&X[tN4-N4],1,o,(int)C,1);
