...
int softsign_s (float *Y, const float *X, const size_t N)
{
    for (size_t n=N; n>0u; --n, ++X, ++Y) { *Y = (*X>0.0f) ? *X/(1.0f+*X) : *X/(1.0f-*X); }
...
int softsign_d (double *Y, const double *X, const size_t N)
{
    for (size_t n=N; n>0u; --n, ++X, ++Y) { *Y = (*X>0.0) ? *X/(1.0+*X) : *X/(1.0-*X); }
...
int softsign_inplace_s (float *X, const size_t N)
{
    for (size_t n=N; n>0u; --n, ++X) { *X = (*X>0.0f) ? *X/(1.0f+*X) : *X/(1.0f-*X); }
...
int softsign_inplace_d (double *X, const size_t N)
{
    for (size_t n=N; n>0u; --n, ++X) { *X = (*X>0.0) ? *X/(1.0+*X) : *X/(1.0-*X); }
