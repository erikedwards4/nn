...
int conv1_torch_s (float *Y, const float *X, const float *K, const float *B, const size_t Nb, const size_t Ni, const size_t No, const size_t Li, const size_t Lk, const int pad, const size_t str, const int ceil_mode, const int pad_mode);
int conv1_torch_d (double *Y, const double *X, const double *K, const double *B, const size_t Nb, const size_t Ni, const size_t No, const size_t Li, const size_t Lk, const int pad, const size_t str, const int ceil_mode, const int pad_mode);
